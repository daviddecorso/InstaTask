...
Canvas nicely provides each user with a live link to their calendar's .ical file, so our app can automatically refresh a user’s feed once an initial URL has been provided. User calendars are saved to their account, allowing access across multiple devices and platforms.
